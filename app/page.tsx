    ...
    <main className="pt-20">
      ...
      <section className="relative min-h-[65vh] sm:min-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center px-8 sm:px-16 pb-8">
          <p className="font-playfair text-white text-2xl sm:text-4xl font-light mb-1 drop-shadow-lg">
            Making Shabbos Possible for Families in
          </p>
          <h1 className="font-playfair font-black text-[#F5A020] text-5xl sm:text-7xl lg:text-8xl leading-tight mb-4 drop-shadow-lg">
            Florida
          </h1>
