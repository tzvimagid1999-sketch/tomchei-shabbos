    ...
    <main className="pt-20">
      ...
      <section className="relative min-h-[65vh] sm:min-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex justify-end gap-2 sm:gap-4 px-8 sm:px-16 pb-14">
          ...
          <Link href="/volunteer"
            className="bg-white/20 backdrop-blur-sm border-2 border-white text-white px-4 py-2 sm:px-10 sm:py-5 rounded-lg sm:rounded-xl font-black text-[11px] sm:text-base uppercase tracking-widest hover:bg-white/30 transition-all duration-150 shadow-lg whitespace-nowrap">
            Get Involved
          </Link>
          <Link href="/contact"
            className="bg-white/20 backdrop-blur-sm border-2 border-white text-white px-4 py-2 sm:px-10 sm:py-5 rounded-lg sm:rounded-xl font-black text-[11px] sm:text-base uppercase tracking-widest hover:bg-white/30 transition-all duration-150 shadow-lg whitespace-nowrap">
      ...
      <div className="bg-[#1AABAB] py-5 text-center">
        <p className="font-playfair italic font-bold text-white text-3xl sm:text-4xl tracking-wide">
