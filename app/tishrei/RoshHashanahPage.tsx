...
export default function RoshHashanah({ initialTotal }: { initialTotal: number | null }) {
  ...
  const tiers = [
    ...
    { value: 150, label: "$150", title: "Sponsor Meat and Chicken for a Family for Sukkot" },
    { value: 600, label: "$600", title: "Succos for a family" },
    { value: 1250, label: "$1,250", title: "Shabbos for 10 families" },
    { value: 1500, label: "$1,500", title: "Sponsor Meat and Chicken for 10 Families for Sukkot" },
